...
const DartCard: React.FC<{ step: DartPathStep; index: number }> = ({ step, index }) => {
  if (!step) return null;
  ...
  return (
    <div className={`relative flex flex-col items-center justify-center w-24 h-32 md:w-28 md:h-36 border-2 rounded-xl ${borderColor} ${bgColor} transition-all shadow-lg shadow-black/40`}>
...
export const PathVisualizer: React.FC<Props> = ({ path }) => {
