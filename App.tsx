...
const App: React.FC = () => {
  ...
  const handleScoreChange = (val: string) => {
    ...
    if (!isNaN(num)) {
      ...
      setScore(0); // Erlaubt das Löschen für neue Eingabe
    }
  };
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 p-4 md:p-6 lg:p-8 font-sans selection:bg-red-500/30">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        {/* Professional Header */}
        <div className="lg:col-span-12 flex flex-col sm:flex-row sm:items-center justify-between border-b border-slate-800 pb-4 mb-2 gap-4">
        ...
        <div className="lg:col-span-8 space-y-6">
          <div className="bg-slate-900 border border-slate-800 rounded-3xl p-6 md:p-8 shadow-2xl relative overflow-hidden min-h-[450px] flex flex-col">
                 ...
                 <div className="flex-1 flex flex-col">
                   ...
                   <div className="mt-auto">
                     <div className="bg-slate-950/80 rounded-2xl p-5 border border-slate-800 shadow-xl">
                        ...
                        <p className="text-slate-300 text-sm leading-relaxed italic border-l border-slate-800 pl-4">
                          {result.explanation}
                        </p>
                     </div>
                   </div>
          ...
          {result && result.missScenarios && result.missScenarios.length > 0 && (
             <div className="bg-slate-900/40 border border-slate-800 border-l-4 border-l-amber-600 rounded-r-3xl p-6 shadow-2xl">
